...
function phaseMarkerClass(state: ExecutionGraphStatus) {
  ...
  if (state === 'cancelling' || state === 'cancelled') return 'border-border-subtle bg-surface-soft text-ink-muted'
  ...
  const agentPulse = hasPortfolioLoadFailure
    ...
    : agentPulseActive
      ...
      : queuedCount
        ...
        : { label: 'Agentes en espera', tone: 'bg-ink-muted/60', state: 'en espera' }
