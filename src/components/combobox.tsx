    ...
    >
      ...
      >
        ...
        <Headless.ComboboxButton className="group absolute inset-y-0 right-0 flex items-center px-2">
          <svg
            className="size-5 stroke-ink-muted group-data-disabled:stroke-ink-muted group-data-hover:stroke-ink-muted sm:size-4 dark:stroke-ink-secondary dark:group-data-hover:stroke-ink-secondary forced-colors:stroke-[CanvasText]"
            viewBox="0 0 16 16"
            aria-hidden="true"
            fill="none"
          >
