...
export function Legend({
  ...
  return (
    <Headless.Legend
      ...
      className={clsx(
        className,
        'text-base/6 font-semibold text-[var(--app-text-primary)] data-disabled:opacity-50 sm:text-sm/6'
      )}
    />
  )
}
...
export function Label({ className, ...props }: { className?: string } & Omit<Headless.LabelProps, 'as' | 'className'>) {
  return (
    <Headless.Label
      ...
      className={clsx(
        className,
        'text-base/6 text-[var(--app-text-primary)] select-none data-disabled:opacity-50 sm:text-sm/6'
      )}
    />
  )
}
...
export function Description({
  ...
  return (
    <Headless.Description
      ...
      {...props}
      className={clsx(className, 'text-base/6 text-[var(--app-text-secondary)] data-disabled:opacity-50 sm:text-sm/6')}
    />
  )
}
