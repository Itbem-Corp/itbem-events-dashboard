...
const colors = {
  ...
  zinc: 'bg-zinc-600/10 text-ink-muted group-data-hover:bg-zinc-600/20 dark:bg-white/5 dark:text-ink-secondary dark:group-data-hover:bg-white/10',
}
...
export const BadgeButton = forwardRef(function BadgeButton(
  ...
  let classes = clsx(
    className,
    'group relative inline-flex rounded-md focus:not-data-focus:outline-hidden data-focus:outline-2 data-focus:outline-offset-2 data-focus:outline-(--tenant-accent)'
  )
