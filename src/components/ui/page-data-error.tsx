...
export function PageDataError({
  ...
  return (
    <section className="flex min-h-[56vh] items-center justify-center py-10" role="alert" aria-live="polite">
      <div className="relative w-full max-w-lg overflow-hidden rounded-3xl border border-red-400/15 bg-zinc-950/70 p-7 text-center shadow-2xl shadow-black/15 sm:p-9">
        ...
        <div className="relative">
          ...
          <p className="mx-auto mt-3 max-w-sm text-sm leading-6 text-zinc-400">{description}</p>
