...
const reasonLabels: Record<string, string> = {
  ...
  policy_evidence_invalid: 'La evidencia de política efectiva no es válida.',
  repository_policy_missing: 'Falta una política aplicable para este repositorio.',
  repository_policy_unresolved: 'La política de este repositorio todavía no está resuelta.',
  policy_action_not_allowed: 'La política de este repositorio no permite esta acción.',
  target_branch_not_allowed: 'La política de este repositorio no permite el branch destino.',
  repository_policy_evidence_invalid: 'La evidencia de política de este repositorio no es válida.',
  repository_policy_evidence_duplicate: 'Existe evidencia de política duplicada para este repositorio.',
